...
문자열 슬라이싱(slicing) : 문자열의 인덱스를 활용하여 한 문자 이상으로 구성된 단어나 문장을 추출할때 사용하는 방법
추출하고자 하는 단어나 문장의 시작 인덱스와 종료 인덱스를 통해 그 사이 문자들을 추출할수 있음.
...
맨 마지막 숫자는 5입니다.
맨 마지막 숫자는 5이며, 홀수입니다. -> 조건문써야 합니다. 

'''

number = input('네자리 숫자를 입력하세요 >>>')
...
if last_number % 2 == 0:
    ...
    result = '홀수입니다'
print(f'맨마지막 숫자는 {last_number}입니다.')
print(f'맨마지막 숫자는 {last_number}이며, {result}')